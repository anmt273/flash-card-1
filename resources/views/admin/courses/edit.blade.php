    ...
    <div class="col-sm-6">
        <div class="panel">
            ...
            <div class="panel-body">
                <form action="{{route('admin.course.edit',['id' => $course->id])}}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="desc" value="{{$course->desc}}" required>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="ckbox ckbox-inline ckbox-info">
                                    <input type="checkbox" {{$course->share?'checked':''}}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
